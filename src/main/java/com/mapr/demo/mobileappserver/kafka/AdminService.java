package com.mapr.demo.mobileappserver.kafka;
...
public class AdminService {
    ...
    public void createStreamAndTopicIfNotExists(String topic) {
        ...
        createStreamAndTopicIfNotExists(nameParts[0], nameParts[1]);
    }

    public void createStreamAndTopicIfNotExists(String stream, String topic) {
        createStreamIfNotExists(stream);
        createTopicIfNotExists(stream, topic);
    }
